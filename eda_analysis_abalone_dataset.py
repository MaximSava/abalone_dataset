...
sns.kdeplot(data = df, x="Height", y = "Rings")
sns.kdeplot(data = dataset_droped,x=sex)
sns.lmplot(x = "Gender", y= "Rings", data = df)
sns.kdeplot(df.Diam,df.Rings,shade=True,shade_lowest=False,cmap='Reds')
sns.kdeplot(dataset.Diameter,dataset.Rings,cmap='Reds')

f, axes  = plt.subplots(1,2)
sns.kdeplot(df.Diam,df.Rings,cmap='Reds',ax = axes[0])
sns.kdeplot(df.Shell_weight,df.Rings,cmap='Reds',ax = axes[1])
